    ...
    public static class ExceptionManager
    {
        public static void Resolve(Exception ex)
        {
            ...
            if (exProc.HasLink)
            {
                ...
                if (MessageBox.Show(exProc.Message, "Erro", MessageBoxButtons.OKCancel, MessageBoxIcon.Error) == DialogResult.OK)
                {
            ...
            else if (exProc.OleDb)
            {
                ...
                MessageBox.Show(exProc.Message, "Erro", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
